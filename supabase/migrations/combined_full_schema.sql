-- ============================================================
-- HABIT TRACKER — COMPLETE SCHEMA
-- Includes all migrations: 0001_init + 0002_profiles + 0003_fix_rls_recursion
-- ============================================================
...
-- Security definer helper to break RLS recursion on team_members
...
-- Teams: visible to any authenticated user (needed for create
-- the .select() flow and join-by-invite-code lookup).
-- The real access control is at the habits/checkins level.
...
-- Checkins: you can see checkins for anyone on your team
...
-- ============================================================
-- 6. PROFILES TABLE (from 0002_profiles.sql)
-- ============================================================
